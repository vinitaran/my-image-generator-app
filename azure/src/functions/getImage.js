...
app.http("getImages", {
  ...
  handler: async (request, context) => {
    ...
    //new ES6 function - sort
    const sortedImageUrls = imageUrls.sort((a, b) => {
        //a-drawing-of-tiger-on-moon_0987345322.png
        //split at _ and pop first part --> 0987345322.png
        //convert it to string and split at . and shift will give the first part --> 0987345322
      const aName = a.name.split("_").pop().toString().split(".").shift();
      const bName = b.name.split("_").pop().toString().split(".").shift();
      return bName - aName; //will give the difference
    });
